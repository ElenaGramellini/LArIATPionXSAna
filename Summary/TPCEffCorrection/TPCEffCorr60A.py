...
pionMC_FileName = "/Users/elenag/Documents/Papers/ThatsIt/code/TrueTree/secondTry/Summary/WC2TPCEff/applyWC2TPCWeightsToRecoSamples/atanFiles/MC60APionsReco_histo.root"
...
pionTrue_5_Int  = pionTrue_5.Get("pionTrue_60_Int")
pionTrue_5_Inc  = pionTrue_5.Get("pionTrue_60_Inc")



###############################################################################

eff_Corr_5_Int = pionMC_Int.Clone("eff_Corr_5_Int_60A")
eff_Corr_5_Int.Sumw2()
pionTrue_5_Int.Sumw2()
eff_Corr_5_Int.Divide(pionTrue_5_Int)   

eff_Corr_5_Inc = pionMC_Inc.Clone("eff_Corr_5_Inc_60A")
eff_Corr_5_Inc.Sumw2()
pionTrue_5_Inc.Sumw2()
eff_Corr_5_Inc.Divide(pionTrue_5_Inc)   

moveXS_5 = eff_Corr_5_Inc.Clone("move_XS_5_60A")
...
#######################    Closure Check   ###########################
#####################################################################
hTrueXS_5 = calculateXSPlot(pionTrue_5_Int, pionTrue_5_Inc, "TrueXS60A"  )
hRecoXS_5 = calculateXSPlot(pionMC_Int    , pionMC_Inc    , "RecoXS60A"  )
