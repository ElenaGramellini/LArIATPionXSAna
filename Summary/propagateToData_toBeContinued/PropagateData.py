...
h5.SetMarkerSize(.72)
XS100_B = h5.Clone("XS100AWeightAndBkgSub")
XS100_B.Multiply(bkgSub_100XS)
XS100 = XS100_B.Clone("XS100AWeightBkgSubAndCorrected")
...
h3.SetMarkerSize(.72)
XS60_B = h3.Clone("XS60AWeightAndBkgSub")
XS60_B.Multiply(bkgSub_60XS)
XS60 = XS60_B.Clone("XS60AWeightBkgSubAndCorrected")
...
outFile = TFile("StepByStepData.root","recreate")
outFile.cd()
