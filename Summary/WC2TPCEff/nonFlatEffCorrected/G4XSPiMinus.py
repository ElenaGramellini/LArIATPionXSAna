...
f = TFile("../../FiducialVolumeStudy/askForInt/FidVol_Z90.0_19.0_-19.0_46.0_1.0_TrueInt_100A.root")
h = f.Get( "XS")
...
f3 = TFile("NonFlatEffCorrectedSameFidVol_Z86.0_19.0_-19.0_46.0_1.0100.root")
h3 = f3.Get( "XS")
...
f5 = TFile("NonFlatEffCorrectedSameFidVol_Z86.0_19.0_-19.0_46.0_1.060.root")
h5 = f5.Get( "XS")
...
legend.AddEntry(h5,"Non Flat Eff  60A, WC2TPC weighted")
legend.AddEntry(h3,"Non Flat Eff 100A, WC2TPC weighted")
#legend.AddEntry(h4,"Fid Vol, Z [0., 86.] cm, flat wc2tpc eff 0.3, 100A")
