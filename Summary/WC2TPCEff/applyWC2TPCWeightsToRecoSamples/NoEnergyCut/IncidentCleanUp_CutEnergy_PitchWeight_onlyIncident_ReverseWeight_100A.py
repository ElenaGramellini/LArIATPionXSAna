...
parser.add_argument("fileName"     , nargs='?', default = "/Users/elenag/Documents/Papers/ThatsIt/rootFiles/MC100APionsReco_histo.root", type = str, help="insert fileName")
...
for entry in myTree:
     ...
     if recoEndZ < recoVtxZ:
         distance = recoVtxZ
     decisionW = 1./efficiencyFunct(distance,0)
