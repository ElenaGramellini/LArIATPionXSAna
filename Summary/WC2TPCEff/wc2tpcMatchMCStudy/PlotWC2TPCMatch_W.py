...
WC2TPCMatch60A.SetTitle("WC2TPC Match 60A; True Track Length [cm]; Events After Match / Events Before Match")
...
WC2TPCMatch100A.SetTitle("WC2TPC Match 100A; True Track Length [cm]; Events After Match / Events Before Match")
