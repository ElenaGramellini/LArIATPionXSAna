...
f = TFile("../askForInt/FidVol_Z90.0_19.0_-19.0_46.0_1.0_TrueInt_60A.root")
h = f.Get( "XS")
...
f3 = TFile("SameFidVol_Z89.0_19.0_-19.0_46.0_1.060.root")
h3 = f3.Get( "XS")
...
f5 = TFile("SameFidVol_Z86.0_19.0_-19.0_46.0_1.060.root")
h5 = f5.Get( "XS")
...
f4 = TFile("SameFidVol_Z30.0_19.0_-19.0_46.0_1.060.root")
h4 = f4.Get( "XS")
...
legend.AddEntry(h ,"True XS 60A")
legend.AddEntry(h3,"Same Fiducial Volume, 60A, Z [0., 89.] cm")
legend.AddEntry(h5,"Same Fiducial Volume, 60A, Z [0., 86.] cm")
legend.AddEntry(h4,"Same Fiducial Volume, 60A, Z [0., 30.] cm")
