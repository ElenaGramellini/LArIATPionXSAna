...
f = TFile("FidVol_Z90.0_19.0_-19.0_46.0_1.0_TrueInt_60A.root")
h = f.Get( "XS")
...
f3 = TFile("FidVol_Z89.0_19.0_-19.0_46.0_1.0_TrueInt_60A.root")
h3 = f3.Get( "XS")
...
f5 = TFile("FidVol_Z86.0_19.0_-19.0_46.0_1.0_TrueInt_60A.root")
h5 = f5.Get( "XS")
...
f4 = TFile("FidVol_Z30.0_19.0_-19.0_46.0_1.0_TrueInt_60A.root")
h4 = f4.Get( "XS")
...
legend.AddEntry(h ,"True Interaction, 60A, Z [0., 90.] cm")
legend.AddEntry(h3,"True Interaction, 60A, Z [0., 89.] cm")
legend.AddEntry(h5,"True Interaction, 60A, Z [0., 86.] cm")
legend.AddEntry(h4,"True Interaction, 60A, Z [0., 30.] cm")
